...
var FAKE_OUTLET = {
    ...
    if (on) {
          ...
          eventEmitter.emit('OutletAOn');
          console.log("...outlet is now on.");
    } else {
          FAKE_OUTLET.powerOn = false;
          if(err) { return console.log(err); }
          eventEmitter.emit('OutletAOff');
...
var outletUUID = uuid.generate('hap-nodejs:accessories:OutletA');

// This is the Accessory that we'll return to HAP-NodeJS that represents our fake light.
var outlet = exports.accessory = new Accessory('OutletA', outletUUID);

// Add properties for publishing (in case we're using Core.js and not BridgedCore.js)
outlet.username = "1A:AA:3C:4D:5D:FF";
