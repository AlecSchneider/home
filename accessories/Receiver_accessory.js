...
var FAKE_OUTLET = {
    ...
    console.log("Turning the receiver %s!...", on ? "on" : "off");
    if (on) {
          FAKE_OUTLET.powerOn = true;
          eventEmitter.emit('receiverOn');
          if(err) { return console.log(err); }
          console.log("...receiver is now on.");
    } else {
          FAKE_OUTLET.powerOn = false;
          if(err) { return console.log(err); }
          eventEmitter.emit('receiverOff');
          console.log("...receiver is now off.");
    }
  },
    identify: function() {
...
var outletUUID = uuid.generate('hap-nodejs:accessories:ROutlet');

// This is the Accessory that we'll return to HAP-NodeJS that represents our fake light.
var outlet = exports.accessory = new Accessory('Receiver', outletUUID);
