...
var FAKE_LIGHT = {
  ...
  setPowerOn: function(on) {
    ...
    if (FAKE_LIGHT.powerOn != on) {
        ...
        if(FAKE_LIGHT.powerOn) {
            client.publish('drinklight', 'on');
        } else {
            client.publish('drinklight', 'off');
        }
    }
  ...
  setBrightness: function(brightness) {
    ...
    client.publish('drinklight/color', newColor)
  },
  setHue: function(hue){
...
var lightUUID = uuid.generate('hap-nodejs:accessories:DrinkLEDLight');

// This is the Accessory that we'll return to HAP-NodeJS that represents our fake light.
var light = exports.accessory = new Accessory('DrinkLEDLight', lightUUID);
